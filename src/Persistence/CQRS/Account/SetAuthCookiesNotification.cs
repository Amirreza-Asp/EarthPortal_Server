...
{
    public class SetAuthCookiesNotificationHandler
        : INotificationHandler<SetAuthCookiesNotification>
    {
        private readonly IRepository<User> _userRepo;
        private readonly IHttpContextAccessor _contextAccessor;
        private readonly IMemoryCache _memoryCache;

        public SetAuthCookiesNotificationHandler(
        ...
        public async Task Handle(
            SetAuthCookiesNotification notification,
        ...
        )
        {
            ...
            var ip =
                _contextAccessor.HttpContext.Request.HttpContext.Connection.RemoteIpAddress.ToString();

            var token = JWTokenService.GenerateToken(
                user.UserName,
                user.Role.Title,
                ip,
                user.Email,
