...
{
    public class RemoveVideoContentCommandHandler
        : IRequestHandler<RemoveVideoContentCommand, CommandResponse>
    {
        private readonly ApplicationDbContext _context;
        private readonly ILogger<RemoveVideoContentCommandHandler> _logger;
        private readonly IUserAccessor _userAccessor;

        public RemoveVideoContentCommandHandler(
            ApplicationDbContext context,
            ILogger<RemoveVideoContentCommandHandler> logger,
        ...
        public async Task<CommandResponse> Handle(
            RemoveVideoContentCommand request,
        ...
        )
        {
            ...
            if (await _context.SaveChangesAsync(cancellationToken) > 0)
            {
                _logger.LogInformation(
                    "VideoContent with id {Username} removed by {UserRealName} in {DoneTime}",
                    video.Id,
